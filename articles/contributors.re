...
//embed{
    ...
    \hspace{1ex}
//}
主活動は「レーザープロジェクタを自作するためのいろいろ」で電子工作ネタで執筆中。コミケと技術書典に出没。デッドライナーだけど、最近締め切りをでっち上げて自分の尻を叩く方法を学んだので、コンスタントに本が書けるようになった。プログラミングは苦手。しめきりたのしー。初の商業本を2018年4月発行。技術同人誌関係のコミュニティでいろいろやるのが楽しくて仕方ないここ最近。
